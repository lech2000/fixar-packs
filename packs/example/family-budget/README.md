...
**Сегодня пак в деле не работает, даже поставленный.** Проверено 13.09.2026
на живой площадке: договор на пак в деле заключается и подписывается, но
площадка ещё не переводит дело на направление стороннего пака — шаблон дела и
агенты пака в деле сами не включаются. Договор говорит это в своём тексте.
Слово «Работает» в таблице выше значит «объявлено направлением и будет
работать, когда дело встанет на пак», а не «можно попробовать сейчас».
